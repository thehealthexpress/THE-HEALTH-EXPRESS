  ...
  return (
    <section className="bg-gradient-to-r from-green-100 to-green-200 py-16">
      <div className="container mx-auto px-4 text-center">
        <h1 className="text-4xl font-bold text-green-800 mb-4">Order Food Online</h1>
        <p className="text-green-700 mb-8">Delicious meals delivered in 30 mins within 6km</p>
